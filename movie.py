...
def findID(id): #to find if a id is in the database
    data = [id]
...
while True:
    ...
    main_menu_input = input('Enter \033[1m"A"\033[0m to add, delete, update movies \nEnter \033[1m"B"\033[0m for main functions\n').lower().strip()
